...
# The scripts are tracked, their run output is not: evidence goes to a gitignored build
# directory, and not to installer_output/, which holds release packages only.
EVIDENCE_ROOT = REPO / "build" / "gui-benchmark-runs"
